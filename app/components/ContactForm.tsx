...
export default function ContactForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setState("success");
      setMessage(
        "Your inquiry is with the ClearGate team. We’ll reply to your work email within one business day.",
      );
    } catch (error) {
      resetSecurityChallenge();
      setState("error");
    ...
    <>
      ...
      >
        ...
        <div className="form-actions">
          ...
          <p>Do not include patient information, adverse-event reports, or confidential clinical data.</p>
        </div>
